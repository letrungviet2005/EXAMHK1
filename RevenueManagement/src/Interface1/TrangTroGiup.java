...
public class TrangTroGiup {
	...
	public static void main(String[] args) {
	     ...
	     JFrame frame = new JFrame("Loi Dang Nhap");
			...
			JLabel lblNewLabel_1 = new JLabel("Mọi thắc mắc vui lòng liên hệ qua gamil vitprofb@gmail.com hoặc số \r\n\r\n");
			lblNewLabel_1.setFont(new Font("Times New Roman", Font.PLAIN, 15));
			lblNewLabel_1.setForeground(Color.BLACK);
			lblNewLabel_1.setBounds(21, 71, 444, 28);
			frame.add(lblNewLabel_1);
			
			JLabel lblNewLabel_2 = new JLabel("điện thoại 0702349310. Xin Cảm Ơn!");
